...
export default function HebergementsPage() {
  return (
    <div className="min-h-screen bg-[#0B0A14] font-sans">
      <Navbar />
      <PageHeader title="Hébergements" subtitle="Hôtels, villas, campements et maisons d'hôtes pour un séjour inoubliable." image="/hero-hebergements.jpg" category="hebergements" />
