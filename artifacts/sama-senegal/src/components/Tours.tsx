...
// Aucun tour fictif par défaut : si Supabase est vide, la section ne
// doit rien afficher plutôt que montrer des tours inventés.
const DEFAULT_TOURS_FALLBACK: any[] = [];
