...
// ✅ Données par défaut — s'initialisent si localStorage est vide
const DEFAULT_RESTAURANTS = [
  {
    id: 1,
    name: "Le Petit Baobab",
    cuisine: "Sénégalaise",
    descFR: "Cuisine traditionnelle sénégalaise au cœur de Dakar",
    descEN: "Traditional Senegalese cuisine in the heart of Dakar",
    descES: "Cocina tradicional senegalesa",
    photo: "",
    priceRange: "$$",
    rating: 5,
  ...
  },
  {
    ...
    name: "Chez Lamine",
    cuisine: "Grillades",
    descFR: "Grillades et fruits de mer frais",
    descEN: "Fresh grilled seafood",
    descES: "Mariscos y parrillas frescas",
    photo: "",
    priceRange: "$$$",
    rating: 5,
...
const DEFAULT_HOTELS = [
  {
    id: 1,
    name: "Hôtel Gorée Saly",
    type: "Hôtel",
    descFR: "Vue panoramique sur l'océan Atlantique",
    descEN: "Panoramic view of the Atlantic Ocean",
    descES: "Vista panorámica del Océano Atlántico",
    photo: "",
    rating: 5,
    rooms: 24,
    priceNight: 85000,
    address: "Saly, Thiès",
    amenities: ["WiFi", "Piscine", "Clim"],
    whatsapp: "221774188107",
    bookingLink: "",
    active: true,
  },
...
const DEFAULT_TRANSPORT = [
  {
    ...
    name: "Toyota HiAce",
    category: "Minibus",
    descFR: "Minibus climatisé 12 places idéal pour les groupes",
    descEN: "Air-conditioned 12-seat minibus",
    descES: "Minibús climatizado de 12 plazas",
    photo: "",
    seats: 12,
    aircon: true,
    driverIncluded: true,
  ...
  },
  {
    ...
    category: "SUV",
    descFR: "Véhicule tout-terrain pour les aventures",
    descEN: "Off-road vehicle for adventures",
    descES: "Vehículo todoterreno para aventuras",
    photo: "",
    seats: 7,
    aircon: true,
    driverIncluded: true,
...
const DEFAULT_MENU = [
  {
    id: 1,
    nameFR: "Thiéboudienne",
    nameEN: "Rice & Fish",
    nameES: "Arroz con Pescado",
    category: "Plat principal",
    descFR: "Le plat national sénégalais",
    descEN: "The Senegalese national dish",
    descES: "El plato nacional senegalés",
    photo: "",
    price: 3500,
    prepTime: 30,
    spiceLevel: "Moyen",
  ...
  },
  {
    ...
    nameES: "Pollo Yassa",
    category: "Plat principal",
    descFR: "Poulet mariné au citron et oignons",
    descEN: "Chicken marinated in lemon and onions",
    descES: "Pollo marinado en limón y cebollas",
    photo: "",
    price: 3000,
    prepTime: 25,
    spiceLevel: "Moyen",
