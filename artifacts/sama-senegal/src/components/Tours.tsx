...
export function Tours() {
  ...
  const tours = [
    { id: 1, icon: "🏛️", name: "Visite guidée Île de Gorée", duration: "4-5h", price: 15000, gradient: "from-[#2C7A5C] to-[#1A1A2E]" },
    { id: 2, icon: "🏙", name: "City Tour Dakar",             duration: "3-4h", price: 20000, gradient: "from-[#C2622D] to-[#5C3D1E]" },
    { id: 3, icon: "🦒", name: "Excursion Bandia",            duration: "1 journée", price: 35000, gradient: "from-[#D4A017] to-[#5C3D1E]" },
    { id: 4, icon: "🎒", name: "Combo Gorée+Dakar",           duration: "1 journée", price: 30000, gradient: "from-[#2C7A5C] to-[#C2622D]" },
    { id: 5, icon: "🌅", name: "Coucher de soleil Gorée",     duration: "2h",        price: 10000, gradient: "from-[#1A1A2E] to-[#D4A017]" },
    { id: 6, icon: "🏜️", name: "Lac Rose",                    duration: "1 journée", price: 25000, gradient: "from-[#C2622D] to-[#2C7A5C]" },
  ];
                ...
                <div className="mt-auto w-full">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      if (select) (select as HTMLSelectElement).value = tour.name;
