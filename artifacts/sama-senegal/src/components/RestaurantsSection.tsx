...
export function RestaurantsSection() {
  ...
  const loadRestaurants = () => {
    ...
    if (saved) {
      try { 
        ...
        setRestaurants(parsed.filter((r: any) => r.active));
      } catch { }
    }
  };
  ...
  useEffect(() => {
    loadRestaurants();
    window.addEventListener("restaurantsDataUpdated", loadRestaurants);
    return () => window.removeEventListener("restaurantsDataUpdated", loadRestaurants);
  }, []);
