...
import { Menu, X, Globe, MessageCircle, User, ChevronDown, LayoutDashboard, LogOut, DollarSign } from "lucide-react";
import {
      ...
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Réserver */}
            <Button className="bg-secondary hover:bg-secondary/90 text-secondary-foreground font-semibold" size="sm"
        ...
        <div className="md:hidden flex items-center gap-2">
          {session && (
            <button onClick={() => session.role === "client" ? setShowDashboard(true) : setShowDashboard(true)}
        ...
        <div className="absolute top-full left-0 w-full bg-background border-b border-border shadow-lg p-4 flex flex-col gap-3 md:hidden">
          ...
          <div className="flex flex-wrap gap-2 pt-1">
            ...
            {currencies.slice(0, 4).map((c) => (
              <Button key={c.code} variant="outline" size="sm" onClick={() => setCurrency(c.code as CurrencyCode)}
